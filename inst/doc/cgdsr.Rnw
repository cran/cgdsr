...
<<>>=
getGeneticProfiles(mycgds,'tcga_gbm')[,c(1:2)]
@
...
<<>>=
getCaseLists(mycgds,'tcga_gbm')[,c(1:2)]
@
...
plot(mycgds, "tcga_gbm", "NF1", c("gbm_cna_rae","gbm_mrna"), "gbm_all", skin = 'disc_cont')
@
\end{center}
...
plot(mycgds, "tcga_gbm", c("MDM2","MDM4"), "gbm_mrna" ,"gbm_all")
@
\end{center}
